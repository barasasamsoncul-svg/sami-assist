...
import { MainSidebar } from "@/app/components/dashboard/MainSidebar";
...
export default function DashboardLayout() {
  ...
  */
  ...
  // Get page title for invoice sub-pages
  const getInvoicePageTitle = (page: string) => {
    const titles: Record<string, string> = {
      "invoice-overview": "Invoice Overview",
      "invoice-stats": "Invoice Statistics",
      "invoices": "All Invoices",
      "create-invoice": "Create Invoice",
      "invoice-drafts": "Draft Invoices",
      "invoice-sent": "Sent Invoices",
      "invoice-overdue": "Overdue Invoices",
      "invoice-paid": "Paid Invoices",
      "invoice-upcoming": "Upcoming Invoices",
      "invoice-payments": "Payments",
      "invoice-credit-notes": "Credit Notes",
      "invoice-recurring": "Recurring Invoices",
      "invoice-customers": "Customers",
      "invoice-products": "Products & Services",
      "invoice-tax-rates": "Tax Rates",
      "invoice-payment-terms": "Payment Terms",
      "invoice-templates": "Invoice Templates",
      "invoice-reminders": "Reminders",
      "invoice-webhooks": "Webhooks",
      "invoice-archive": "Archive",
      "invoice-export": "Export",
      "invoice-share": "Share Links",
  ...
  const currentPageTitle =
    activePage === "dashboard"
      ...
      ? getInvoicePageTitle(activePage)
      : currentApp?.name ||
        activePage;

  const TopBar = () => (
    <header className="flex h-12 flex-shrink-0 items-center justify-between border-b border-gray-200/70 bg-white/90 px-4 backdrop-blur-xl dark:border-gray-800/70 dark:bg-gray-950/90 lg:px-7">
...
// INVOICE PAGES - All invoice sub-pages
