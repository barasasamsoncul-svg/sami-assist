...
export default function RegisterPage() {
  ...
  const handleNext = async () => {
    ...
    try {
       ...
       *
       * IMPORTANT:
       * Do not treat sessionStorage as your final authentication
       * mechanism. The actual account should be created securely
   ...
   * ---------------------------------------------------------
   *
   * This assumes Auth.js is configured with Google.
   *
   * The route:
   * /api/auth/signin/google
   *
   * is provided by Auth.js.
   */
  ...
  const handleGoogleSignIn = () => {
    ...
    /*
     * After Google authentication, send the user to the
     * business/workspace setup page.
     *
     * Google gives us identity information, but SaMi still
     * needs the business information.
     */

    window.location.href =
      '/api/auth/signin/google?callbackUrl=/auth/google-complete';
  };
  ...
  const inputBase =
    'w-full h-[46px] rounded-lg border bg-white dark:bg-gray-900 ' +
    'text-[14px] text-gray-900 dark:text-white ' +
    'placeholder:text-gray-400 dark:placeholder:text-gray-500 ' +
    'px-3.5 outline-none transition-all ' +
          ...
          <div className="px-8 py-8 sm:px-10 sm:py-9">
            ...
            <div className="mb-7">
              ...
              <p className="
                ...
                dark:text-gray-400
              ">
                Create your SaMi workspace and start managing
            ...
            ">
              ...
              <p className="
                ...
                dark:text-gray-500
              ">
                By continuing, you agree to SaMi's terms
