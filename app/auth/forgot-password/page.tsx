...
import { Sun, Moon, ArrowLeft, Mail, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-4 relative">
      ...
      <div className="max-w-md w-full">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="mt-6 text-2xl font-bold text-gray-900 dark:text-white">Forgot Password</h2>
        ...
        {sent ? (
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-800 text-center">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-white">Check your email</h3>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-xl border border-gray-200 dark:border-gray-800">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-2.5 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none"
            ...
            <Link
              href="/auth/login"
              className="mt-4 flex items-center justify-center gap-1 text-sm text-gray-500 hover:text-gray-700 transition"
            >
              <ArrowLeft size={14} />
              Back to Login
            </Link>
